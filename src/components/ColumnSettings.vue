...
<template>
  <section>
    <div class="flex-column">
      <button
        class="btn"
        @click="columnsStore.visible = new Set(columnsStore.displayable)"
      >
        show all
      </button>
      <button class="btn" @click="columnsStore.visible = new Set()">
        hide all
      </button>
      <button
      ...
      <button
        class="btn btn--danger"
        @click="sortStore.reset()"
        :disabled="sortStore.isPristine"
      >
        reset sort
      </button>
    </div>
